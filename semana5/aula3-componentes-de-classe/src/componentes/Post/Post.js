		...
		return(
			<div className="PostContainer" onKeyDown={this.atualizaInput}>
				<header className="Post">
					<img className="Post" src={ this.props.fotoAutor } />
					<span className="Post" >{ this.props.nomeAutor }</span>		
				</header>				
				<article><img className="Post" src={ this.props.imagemPost } /></article>
				<section className="Post">
					<div>
						<img onClick={ this.atualizarCurtidas } className="Post" src={ this.state.iconeCurtidas } />
						{ this.state.curtidas }
					</div>
					<div>
						{ this.state.comentarios }
						<img onClick={ this.atualizarComentarios } className="Post" src={ require('./comment_icon.svg') } />						
					</div>
				</section>
